...
## 🤖 AI Prompt Examples
- Explain introduction to databases in simple terms for beginners.
- Give a simple example of introduction to databases for beginners.
...
## 🤖 AI Prompt Examples
- Explain database concepts and usage in simple terms for beginners.
- Give a simple example of database concepts and usage for beginners.
...
## 🤖 AI Prompt Examples
- Explain types of databases in simple terms for beginners.
- Give a simple example of types of databases for beginners.
...
## 🤖 AI Prompt Examples
- Explain relational databases in simple terms for beginners.
- Give a simple example of relational databases for beginners.
...
## 🤖 AI Prompt Examples
- Explain non-relational databases in simple terms for beginners.
- Give a simple example of non-relational databases for beginners.


Therе is another type of database that is less structured and more flexible, and that is the non-relational type. These databases do not have any tables or rows or columns or relationships. This means that data is just stored somewhere, like a document file. Because there are much fewer constraints, we can easily organize different types of data in any way we see fit and the process will be much simpler than in relational databases.

### Relational vs Non-Relational

## 🤖 AI Prompt Examples
- Explain relational vs non-relational in simple terms for beginners.
- Give a simple example of relational vs non-relational for beginners.
...
## 🤖 AI Prompt Examples
- Explain what is sql in simple terms for beginners.
- Give a simple example of what is sql for beginners.
...
## 🤖 AI Prompt Examples
- Explain database management systems in simple terms for beginners.
- Give a simple example of database management systems for beginners.
...
## 🤖 AI Prompt Examples
- Explain microsoft sql server and ssms in simple terms for beginners.
- Give a simple example of microsoft sql server and ssms for beginners.
...
## 🤖 AI Prompt Examples
- Explain mssql database and basic features in simple terms for beginners.
- Give a simple example of mssql database and basic features for beginners.


### Access your local databases

## 🤖 AI Prompt Examples
- Explain access your local databases in simple terms for beginners.
- Give a simple example of access your local databases for beginners.


### Data Types

## 🤖 AI Prompt Examples
- Explain data types in simple terms for beginners.
- Give a simple example of data types for beginners.
...
## 🤖 AI Prompt Examples
- Explain create a database in simple terms for beginners.
- Give a simple example of create a database for beginners.
...
## 🤖 AI Prompt Examples
- Explain delete ( drop ) a database in simple terms for beginners.
- Give a simple example of delete ( drop ) a database for beginners.
...
## 🤖 AI Prompt Examples
- Explain create a table in simple terms for beginners.
- Give a simple example of create a table for beginners.
...
## 🤖 AI Prompt Examples
- Explain get records from a table in simple terms for beginners.
- Give a simple example of get records from a table for beginners.
...
## 🤖 AI Prompt Examples
- Explain add a new record in a table ( insert ) in simple terms for beginners.
- Give a simple example of add a new record in a table ( insert ) for beginners.
...
## 🤖 AI Prompt Examples
- Explain delete records in a table in simple terms for beginners.
- Give a simple example of delete records in a table for beginners.
...
## 🤖 AI Prompt Examples
- Explain update ( alter ) a table in simple terms for beginners.
- Give a simple example of update ( alter ) a table for beginners.
...
## 🤖 AI Prompt Examples
- Explain delete ( drop ) a table in simple terms for beginners.
- Give a simple example of delete ( drop ) a table for beginners.
...
- 7 Business Entities based in the biggest cities in Macedonia
- Around 100 Employees
- Around 100 Customers (Legal Entities)
...
Vitalia  
https://www.vitalia.com.mk/shop-mk/
...
![Orders system](../img/ordersSystem.png)


## Exercises

Create a database called AvengaAcademy.
