...
## 🤖 AI Prompt Examples
- Explain built-in functions with simple examples for beginners.
...
## 🤖 AI Prompt Examples
- Explain programming concepts with simple examples for beginners.
- Give a real-world example for beginners.
...
## 🤖 AI Prompt Examples
- Explain sql programming concepts with simple examples for beginners.
- Give a real-world example for beginners.
...
## 🤖 AI Prompt Examples
- Explain scalar functions with simple examples for beginners.
- Give a real-world example for beginners.
...
![Workshop 02](../img/workshop-02-class04.png)
